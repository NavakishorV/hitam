...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div>Branch:<input type="radio" name="branch" value="other"/>other<input type="radio" name="branch" value="CSE"/>CSE<div style="margin-left:80px"><input type="radio" name="branch" value="ECE"/>ECE<input type="radio" name="branch" value="EEE"/>EEE</div>
            </div>   
...
?>
            ...
            <p style="color:black"><u>Book id:</u> &nbsp&nbsp<?php echo $bookid ?></p>
