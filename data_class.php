...
class data extends db {
    ...
    function addnewuser($id,$name,$pasword,$email,$type){
        $this->id=$id;
        $this->name=$name;
        ...
        $this->type=$type;
         ...
         $q="INSERT INTO userdata(id, name, email, pass,type)VALUES('$id','$name','$email','$pasword','$type')";
    ...
    function addbook($bookid, $bookname, $bookdetail, $bookaudor, $bookpub, $branch, $bookprice, $bookquantity) {
        $this->$bookid=$bookid;
       ...
       $q="INSERT INTO book (bookid,bookname, bookdetail, bookaudor, bookpub, branch, bookprice,bookquantity,bookava,bookrent)VALUES('$bookid', '$bookname', '$bookdetail', '$bookaudor', '$bookpub', '$branch', '$bookprice', '$bookquantity','$bookquantity',0)";
